import type { IEventAny, IPointer } from "./Layer.types.ts";
...
export function createEventManager(el: HTMLElement | Window): IEventManager {
  ...
  function addGlobalListeners() {
    const htmlEl = el as HTMLElement;
    htmlEl.addEventListener("pointerenter", handlePointerEnter, {
      passive: true,
      capture: false,
    });
    ...
    htmlEl.addEventListener("pointermove", handlePointerMove, {
      passive: true,
      capture: false,
    });
    htmlEl.addEventListener("pointercancel", handlePointerCancel, {
      passive: true,
      capture: false,
    });
    htmlEl.addEventListener("pointerleave", handlePointerLeave, {
      passive: true,
      capture: false,
    });
    htmlEl.addEventListener("wheel", handleWheel, {
      passive: true,
      capture: false,
    });
  }
