export type TNextNumber = () => number;

export function sequenceOfUnique(
  ...
  function getNth(n: number) {
    ...
    return permuteQPR(
      ((permuteQPR(n) + intermediateOffset) ^ 0x5bf036) >>> 0,
    );
  }
...
export type TNextStr = () => string;

export function sequenceOfUniqueColor(): TNextStr {
